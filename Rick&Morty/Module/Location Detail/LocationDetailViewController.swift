...
final class LocationDetailViewController: UIViewController {
    ...
    private let presenter: LocationDetailViewPresenter
    private let navigator: LocationDetailViewNavigator
    ...
    init(presenter: LocationDetailViewPresenter, navigator: LocationDetailViewNavigator) {
    ...
    private func updateBasicSnapshots() {
        let name = Item(nameRow: presenter.location.name, detailsRow: nil, charactersRow: nil)
        ...
        let details = Item(nameRow: nil,
                           detailsRow: (type: presenter.location.type, dimension: presenter.location.dimension),
                           charactersRow: nil)
...
extension LocationDetailViewController {
    ...
    struct Item: Hashable {
        let identifier = UUID()
        let nameRow: String?
        let detailsRow: (type: String, dimension: String)?
        let charactersRow: Character?

        static func == (lhs: LocationDetailViewController.Item, rhs: LocationDetailViewController.Item) -> Bool {
...
extension LocationDetailViewController: LocationDetailViewPresenterDelegate {
