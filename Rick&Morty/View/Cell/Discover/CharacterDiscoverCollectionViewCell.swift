//
//  CharacterDiscoverCollectionViewCell.swift
//  Rick&Morty
//
...
class CharacterDiscoverCollectionViewCell: UICollectionViewCell {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate(
            ...
            NSLayoutConstraint.constraints(withVisualFormat: "H:|[imageView]|",
                                           options: [],
                                           metrics: metricsDictionary,
                                           views: viewDictionary),
            NSLayoutConstraint.constraints(withVisualFormat: "H:|-[verticalStackView]-|",
                                           options: [],
                                           metrics: metricsDictionary,
                                           views: viewDictionary)
        )
...
extension CharacterDiscoverCollectionViewCell {
