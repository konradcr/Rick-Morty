//
//  EpisodeInfosCollectionViewCell.swift
//  Rick&Morty
//
...
class EpisodeInfosCollectionViewCell: UICollectionViewCell {
    ...
    static func size(for width: CGFloat, episode: String, date: String) -> CGSize {
        ...
        let attributedString = EpisodeInfosCollectionViewCell.attributedText(episode: episode, date: date)
    ...
    private static func attributedText(episode: String, date: String) -> NSAttributedString {
...
extension EpisodeInfosCollectionViewCell {
    func configure(episode: String, date: String) {
